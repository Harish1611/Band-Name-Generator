...
app.post("/submit", (req, res) => {
  ...
  //Then:
  let randomAdj = Math.floor(Math.random() * (1347 - 0 ) + 0);
  let randomNoune = Math.floor(Math.random() * (4308 - 0 ) + 0);


  var RandomName = adj[randomAdj] +" "+ noun[randomNoune];
  // console.log(adj.length, noun.length)
  
  res.render("index.ejs", { randomWord: RandomName });
